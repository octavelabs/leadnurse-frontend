              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-semibold text-gray-900">
                    {new Date(r.periodStart).toLocaleDateString('en-GB')} â€“ {new Date(r.periodEnd).toLocaleDateString('en-GB')}
                  </p>
                  <p className="text-sm text-gray-500 mt-0.5">{r.entries?.length || 0} workers Â· Â£{r.totalAmount.toFixed(2)} total Â· Generated by {r.generatedBy?.name}</p>
                </div>
