      ...
      {showForm && (
        <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-4">
          ...
          <div className="flex gap-3">
            <button onClick={handleGenerate} disabled={generating} className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 disabled:opacity-50">
            ...
            <div key={r.id} className="bg-white rounded-xl border border-gray-200 p-5">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {r.status === 'DRAFT' && <button onClick={() => handleStatus(r.id, 'SUBMITTED')} className="text-xs text-blue-600 hover:underline">Submit</button>}
